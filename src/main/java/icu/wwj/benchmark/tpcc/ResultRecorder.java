...
public class ResultRecorder {
    ...
    public static final String ADDRESS = ResultRecorder.class.getSimpleName();
    ...
    public ResultRecorder(Vertx vertx, String path) {
    ...
    public Future<Void> close() {
        ...
        return resultConsumer.unregister()
                ...
                .onSuccess(__ -> LOGGER.info("Result recorder closed."))
                .onFailure(cause -> LOGGER.error("Failed to close result recorder", cause));
    }
}
